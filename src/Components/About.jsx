        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-lg leading-relaxed mb-4">
              ...
              , a passionate Full-Stack Developer currently pursuing my
              Bachelor's degree in Information Science and Engineering. I enjoy
              building intuitive, fast, and responsive web applications that
        ...
        <div className="max-w-6xl mx-auto mt-24">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              {
                icon: (
                  <FaJs className="text-5xl text-yellow-400 mx-auto mb-2" />
                ),
                label: "JavaScript",
              },
              {
